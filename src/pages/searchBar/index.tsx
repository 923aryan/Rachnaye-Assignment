...
function SearchPage() {
    ...
    return (
        <>
            <div className="min-h-[35vh] rounded-[8px] w-full flex flex-col justify-between items-center p-5 space-y-4" style={{background: "linear-gradient(150deg, rgb(1, 195, 204), rgb(125, 42, 231))"}}>
